...
export interface IdeaAnalysis {
  ...
  knownCompetitors: string[]; // Specific company names AI knows (e.g., "Arcads", "Synthesia") - used for competitor discovery
}
...
5. **knownCompetitors**: 3-5 specific company names you know that compete in this space (any company, not just YC). These will be used to discover more competitors.
   - Example for "AI UGC video ads": ["Arcads", "Synthesia", "HeyGen", "Creatify"]
   - Example for "expense management": ["Expensify", "Brex", "Ramp", "Divvy"]
   - If you don't know specific competitors, return an empty array []

Respond with ONLY valid JSON, no markdown:
{"initialTake": "...", "searchTerms": ["...", "..."], "subreddits": ["...", "..."], "ycSearchTerms": ["...", "..."], "knownCompetitors": ["...", "..."]}`
        },
        {
          role: "user",
          content: idea,
    ...
    return {
      ...
      knownCompetitors: Array.isArray(analysis.knownCompetitors) ? analysis.knownCompetitors.slice(0, 5) : [],
    };
  } catch (error) {
